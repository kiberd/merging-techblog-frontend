...
export default function SelectBox({ category, list}) {

  return (
    <div className="w-full">
      <Menu as="div" className="relative w-full">
        <div className="w-[100%]">
          <Menu.Button className="flex justify-between w-full px-4 py-2 text-sm font-medium border rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            {category}
            <ChevronDownIcon
