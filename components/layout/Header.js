                    ...
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="hidden md:flex">
                            ...
                            <div class="ml-4 flex items-center md:ml-2">
                                <button type="button" class="inline-flex items-center px-3 py-1 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-100 dark:bg-transparent dark:text-white">
                                    <Link href={'/write'}>
                                        글쓰기
                                    </Link>
                                </button>
