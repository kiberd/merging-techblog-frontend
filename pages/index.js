          ...
          <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:block">
              <div class="ml-4 flex items-center md:ml-6">
                ...
                {isDark ?
                  <div class="cursor-pointer" onClick={handleIsDarkClick}>
        ...
        <nav class="flex items-center justify-between">
          <div class="py-3 px-6 sm:px-12 lg:px-0">
            ...
            <div class="max-w-7xl mx-auto flex items-baseline space-x-4">
              <a href="#" class="text-gray-500 dark:text-gray-300 px-3 py-2 text-sm font-medium border-b-2 border-gray-400" aria-current="page">Tranding</a>
              <a href="#" class="text-gray-500 dark:text-gray-300 px-3 py-2 text-sm font-medium">New</a>
              <a href="#" class="text-gray-500 dark:text-gray-300 px-3 py-2 text-sm font-medium">Search</a>
              {/* <CompanySelectBox/> */}
            </div>
          </div>
