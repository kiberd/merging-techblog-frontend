...
export default function Home() {
  return (
    <div class="min-h-full">
        ...
        <nav class="bg-white flex items-center justify-between">
          <div class="py-3 px-6 sm:px-12 lg:px-0">
            ...
            <div class="max-w-7xl mx-auto flex items-baseline space-x-4">
              <a href="#" class="text-gray-500 px-3 py-2  text-sm font-medium border-b-2 border-gray-500" aria-current="page">Tranding</a>
              <a href="#" class="text-gray-500 px-3 py-2 text-sm font-medium">New</a>
              <a href="#" class="text-gray-500 px-3 py-2 text-sm font-medium">Tech</a>
              <a href="#" class="text-gray-500 px-3 py-2 text-sm font-medium">Company</a>
              {/* <CompanySelectBox/> */}
            </div>
          </div>
      ...
      <main>
        <div class="max-w-25xl mx-auto py-4 sm:px-6 lg:px-8">
